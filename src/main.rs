...
fn test_serialization(){
    ...
    ks
        .serialize_compressed(&mut serialized_data_ks)
        .expect("Serialization should succeed");

// Deserialize MyStruct
    let deserialized_ks = KS::deserialize_compressed(
        serialized_data_ks.as_slice()
...
// dbg!(&deserialized_njm_struct);
    ...
    let ks_sr_test = KS::deserialize_compressed(
        serialized_data_ks.as_slice()
