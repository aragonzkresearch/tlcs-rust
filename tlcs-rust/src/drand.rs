...
pub async fn getChains() -> Result<Vec<String>, Error> {
...
pub async fn getChainsInfo(chain: &String) -> Result<ChainInfo, Error> {
...
pub async fn getChainRound(chain: &String, round: &str) -> Result<ChainRound, Error> {
